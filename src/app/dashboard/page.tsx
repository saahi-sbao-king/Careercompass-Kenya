...
import { Brain, Sparkles, Download, Clock, TrendingUp, Trophy, Plus, Trash2, Loader2, ArrowRight, Briefcase, GraduationCap } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 bg-primary p-12 rounded-[3.5rem] text-primary-foreground shadow-2xl relative overflow-hidden">
        <div className="space-y-4 z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
            Karibu, <span className="text-secondary">{activeAssessment?.userInfo?.name?.split(' ')[0] || 'Scholar'}</span>.
          </h1>
