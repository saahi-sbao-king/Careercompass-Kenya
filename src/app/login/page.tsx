    ...
    <div className="container flex items-center justify-center min-h-[calc(100vh-64px)] px-4 mx-auto">
      <Card className="w-full max-w-md border-primary/10 shadow-2xl rounded-[2.5rem] overflow-hidden">
        ...
        <CardContent className="pt-10 space-y-6">
          <Button 
            className="w-full h-16 text-lg font-black rounded-2xl gap-3 shadow-xl hover:scale-[1.02] transition-transform" 
          ...
          <div className="flex items-center gap-3 p-4 bg-muted/30 rounded-xl border border-dashed">
            ...
            <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest leading-relaxed">
              Secured by Sidmadina Technologies. Your data is encrypted and private.
            </p>
          </div>
        </CardContent>
      </Card>
